...
public final class EnvironmentUtils {
	...
	public static final String DIRETORIO_BIOTI = Environment.getExternalStorageDirectory().getAbsolutePath() + FILE_SEPARATOR + "Neurotechnology";
	...
	public static File getDataDirectory() {
		...
		File directory = null;
		try {
			directory = new File(DIRETORIO_BIOTI);
			if (!directory.exists()) {
				directory.mkdirs();
			}
